...
```bash
curl -O https://raw.githubusercontent.com/danyaaadrain/amneziawg-install/main/amneziawg-install.sh
```
```bash
wget https://raw.githubusercontent.com/danyaaadrain/amneziawg-install/main/amneziawg-install.sh
```
